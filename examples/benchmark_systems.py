...
def _render_comparison_table(summaries: list[dict[str, object]]) -> str:
    ...
    lines = [
        "| Mode | Mean step ms | Tokens/s | Prefill tok/s | Decode tok/s | Padding ratio | Cache reuse | Peak VRAM MB |",
        "|---|---:|---:|---:|---:|---:|---:|---:|",
    ]
    for summary in summaries:
        ...
        lines.append(
            ...
            f"{summary['mean_prefill_tokens_per_second']:.2f} | {summary['mean_decode_tokens_per_second']:.2f} | "
            f"{summary['mean_padding_ratio']:.4f} | {summary['mean_cache_reuse_effectiveness']:.4f} | "
