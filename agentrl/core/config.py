...
class GRPOConfig:
    ...
    use_cuda_graph_decode: bool | None = None
    ...
    def __post_init__(self) -> None:
        ...
        self._validate_positive_int("prefix_cache_block_size", self.prefix_cache_block_size)
        ...
        if self.prefix_cache_max_bytes is not None and self.prefix_cache_max_bytes < 0:
            raise ConfigurationError("prefix_cache_max_bytes must be >= 0 when provided.")
